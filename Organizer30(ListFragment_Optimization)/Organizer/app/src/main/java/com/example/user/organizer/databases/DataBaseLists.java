...
public class DataBaseLists extends SQLiteOpenHelper{
    ...
    public static String[] listRepeatNames ={"Не повторять", "Ежедневно", "Ежедневно (Пн-Пт)",
            "Еженедельно", "Ежемесячно", "Ежегодно", "Другое..."};

    public static String[] defaultListsNames = {"Разное", "Личный", "Покупки", "Работа"};
    ...
    public DataBaseLists(Context context) { super(context, DATABASE_NAME, null, DATABASE_VERSION); }
