    ...
    public class MyTaskAdapter extends ArrayAdapter<String> {
        ...
        public View getView(final int position, View convertView, ViewGroup parent) {
            ...
            if(viewHolder.dateOfItemTask.getText().toString().compareTo("Дата не установлена") == 0) {
                ...
                viewHolder.dateOfItemTask.setTextColor(Color.RED);
                viewHolder.timeOfItemTask.setTextColor(Color.RED);
            ...
            if(position == 0){
                if (DataBaseTasks.getCertainTask(databaseTasks, this.arrayTasks.get(position))[1].compareTo("Дата не установлена") == 0) {
                    ...
                    viewHolder.typeTasks.setVisibility(View.VISIBLE);
                    viewHolder.typeTasks.setText("Дата установлена");
                ...
                if (DataBaseTasks.getCertainTask(databaseTasks, this.arrayTasks.get(position))[1].compareTo("Дата не установлена") == 0 &&
                        DataBaseTasks.getCertainTask(databaseTasks, this.arrayTasks.get(position - 1))[1].compareTo("Дата не установлена") != 0) {
                    ...
                    viewHolder.typeTasks.setTextColor(getActivity().getColor(R.color.SecondaryText));
                        ...
                        !((System.currentTimeMillis()) < Long.valueOf(DataBaseTasks.getCertainTask(databaseTasks, this.arrayTasks.get(position - 1))[6]))) {
