...
public class NewTask extends AppCompatActivity implements View.OnClickListener {
    ...
    Button btnRepeat, btnAddToList, btnReadDatabase, btnClearDatabase, btnReadDBTasks, btnReadDBFTasks, btnClearDBTasks, btnClearDBFTasks;
    ...
    private void setInitialDate(long date) {
        ...
        // ЕСЛИ ВРЕМЯ УЖЕ ЕСТЬ И УСТАНАВЛИВАЕМ ДАТУ ТО ТУТ БУДЕТ ПРАВИЛЬНАЯ УСТАНОВЛЕННАЯ ДАТА НО НЕПРАВИЛЬНОЕ УСТАНОВЛЕННОЕ ВРЕМЯ!!!!!!
