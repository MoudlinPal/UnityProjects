...
public class DataBaseFinishedTasks extends SQLiteOpenHelper{
    ...
    public static void deleteCertainFinishedTaskAndAddToDBTasks(SQLiteDatabase db, SQLiteDatabase databaseTasks, SQLiteDatabase databaseLists, String task) {
        ...
        class DeleteCertainTask implements Runnable {
            ...
            public DeleteCertainTask(SQLiteDatabase db, SQLiteDatabase databaseTasks, SQLiteDatabase databaseLists, String task) {
                this.db = db;
                this.task = task;
                ...
                if(cursor.moveToFirst())
                {
                    ...
                    do {
                        ...
                        if(someTask.compareTo(task) == 0)
                        {
                            ...
                            DataBaseTasks.addToDBTasks(databaseTasks, someTask, someDate, someTime, someRepeat, someList, someTimeInMillis);
        ...
        Runnable r = new DeleteCertainTask(db, databaseTasks, databaseLists, task);
        new Thread(r).start();
